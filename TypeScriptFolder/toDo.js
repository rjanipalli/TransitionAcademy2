...
var Todo1 = /** @class */ (function () {
    function Todo1(name, description, done) {
        this.name = name;
...
var ActivityList = /** @class */ (function () {
    ...
    ActivityList.prototype.createNewActivity = function (name, description) {
        var newActivity = new Todo(name, description, false);
        var totalCount = ActivityList.allActivity.push(newActivity);
        return totalCount;
    };
    ActivityList.prototype.allActivity = function () {
        return ActivityList.allActivity;
    };
    ActivityList.allActivity = new Array;
    return ActivityList;
}());
...
window.onload = function () {
    ...
    (_a = document.getElementById("addToDo")) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () { return loadActivity(task, description); });
};
function loadActivity(task, description) {
    ...
    for (var i = 0; i < ActivityList.allActivity.length; i++) {
